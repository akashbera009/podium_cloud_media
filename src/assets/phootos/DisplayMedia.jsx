                ...
                <div className="image-gallery">
                    {images.map((media) => (
                        ...
                        media.filePath.slice(-3) === 'mp4' ? (<>
                            <p className='filename'>{media.filename}</p>
                            <div className="video-container">
                                ...
                                {isPlaying && (
                                    <div className="pause-button" onClick={handleStopPlay}></div>
                                )}
                                <div className="fullscreen-button" onClick={() => openModal(media)}>
                             <svg
                                    version="1.1"
                                    id="Layer_1"
                                    ...
                                    enableBackground="new 0 0 122.88 122.76"
                                    xmlSpace="preserve"
                                    width='20px'
                                    height='20px'
                                    fill='white'
                                >
                                    <g>
                                    <path d="M114.89,89.82c0-2.21,1.79-4,4-4c2.21,0,4,1.79,4,4v28.75c0,2.21-1.79,4-4,4H89.67c-2.21,0-4-1.79-4-4c0-2.21,1.79-4,4-4
                                        h19.18L74.49,82.09c-1.6-1.51-1.68-4.03-0.17-5.64c1.51-1.6,4.03-1.68,5.64-0.17l34.93,33.02V89.82L114.89,89.82z M89.82,7.99
                                        c-2.21,0-4-1.79-4-4c0-2.21,1.79-4,4-4h28.75c2.21,0,4,1.79,4,4v29.21c0,2.21-1.79,4-4,4c-2.21,0-4-1.79-4-4V14.03L82.09,48.39
                                        c-1.51,1.6-4.03,1.68-5.64,0.17c-1.6-1.51-1.68-4.03-0.17-5.64L109.3,7.99H89.82L89.82,7.99z M7.99,32.76c0,2.21-1.79,4-4,4
                                        c-2.21,0-4-1.79-4-4V4.01c0-2.21,1.79-4,4-4h29.21c2.21,0,4,1.79,4,4c0,2.21-1.79,4-4,4H14.03l34.36,32.48
                                        c1.6,1.51,1.68,4.03,0.17,5.64c-1.51,1.6-4.03,1.68-5.64,0.17L7.99,13.28V32.76L7.99,32.76z M32.94,114.77c2.21,0,4,1.79,4,4
                                        c0,2.21-1.79,4-4,4H4.19c-2.21,0-4-1.79-4-4V89.55c0-2.21,1.79-4,4-4c2.21,0,4,1.79,4,4v19.18l32.48-34.36
                                        c1.51-1.6,4.03-1.68,5.64-0.17c1.6,1.51,1.68,4.03,0.17,5.64l-33.02,34.93H32.94L32.94,114.77z"/>
                                    </g>
                                </svg>
                             </div>
                            </div>
                       ...
                       { selectedMedia.filePath.slice(-3)=== 'mp3'? (
                        <>
                         <p className='filename'>{selectedMedia.filename}</p>                        
                            ...
                            <p className='filename'>{selectedMedia.filename}</p>
                            <img src={selectedMedia.filePath} alt={selectedMedia.description} className="modal-image" />
                        </>)     
                    }
                    </>)}
